...
import '../dynamic_form_screen/dynamic_form_screen.dart';
...
class _OtpVerificationScreenState extends ConsumerState<OtpVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    final otpVerificationState = ref.watch(otpVerificationProvider);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  otpVerificationState.when(
                    data: (_) => Padding(
                      padding: const EdgeInsets.only(top: 20.0, bottom: 20),
                      child: PrimaryButton(
                        isEnabled: _validateOtp(_otpTextController.text.trim()),
                        onPress: () async {
                          await ref
                          ...
                          final loginSuccess =
                              ref.read(otpVerificationProvider).maybeWhen(
                                    data: (_) => true,
                                    orElse: () => false,
                                  );
                          if (loginSuccess) {
